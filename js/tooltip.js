...
var tooltip_header = tooltip.append("div").attr("class", "tooltip-header");

d3.select(".tooltip")
  .select("div.tooltip-header")
  .append("div")
...
tooltip.append("div").attr("class", "tooltip-post").text("example text");
